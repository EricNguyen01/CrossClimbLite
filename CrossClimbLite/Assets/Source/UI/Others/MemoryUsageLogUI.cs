...
namespace CrossClimbLite
{
    ...
    public class MemoryUsageLogUI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (MemoryUsageLogger.memoryUsageLoggerInstance)
            {
                if(MemoryUsageLogger.memoryUsageLoggerInstance.toggleLogUIKey != KeyCode.None && MemoryUsageLogger.memoryUsageLoggerInstance.toggleLogUIKey != toggleLogUIKey)
                {
                    toggleLogUIKey = MemoryUsageLogger.memoryUsageLoggerInstance.toggleLogUIKey;
                }
            }
        }
