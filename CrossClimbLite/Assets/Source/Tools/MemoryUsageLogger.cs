...
namespace CrossClimbLite
{
    ...
    public class MemoryUsageLogger : MonoBehaviour
    {
        ...
        [SerializeField] 
        [Min(0.02f)]
        private float logToTextIntervalSec = 1.0f;
        ...
        [SerializeField] 
        [ReadOnlyInspector]
        private float memoryLogUIDisplayRefreshTime = 1.0f;

        [field: SerializeField] public KeyCode toggleLogUIKey { get; private set; } = KeyCode.F12;
        ...
        private void OnValidate()
        {
            ...
            memoryLogUIDisplayRefreshTime = logToTextIntervalSec;
        ...
        public static void CreateMemoryLoggerInstance()
        {
            ...
            if (FindAnyObjectByType<MemoryUsageLogger>()) return;
